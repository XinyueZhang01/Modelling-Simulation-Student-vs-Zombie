...
### **1. `Hideandseek.nb`**
*Scenario:* Resource availability reduces encounters (hide-and-seek dynamics).

### **2. `Fightback.nb`**
*Scenario:* Humans fight back and can repel zombie attacks.

### **3. `Technologydevelopment.nb`**
*Scenario:* Technology shifts encounters in favour of humans.
